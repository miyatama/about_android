 ...
 * events.
 */
class DisplayRotationHelperImpl(context: Context) : DisplayRotationHelper, DisplayListener {
     ...
     */
    override fun updateSessionIfNeeded(session: Session) {
        if (viewportChanged) {
     ...
     */
    override fun getCameraSensorRelativeViewportAspectRatio(cameraId: String?): Float {
     ...
     * 0, 90, 180, 270.
     */
    override fun getCameraSensorToDisplayRotation(cameraId: String?): Int {
